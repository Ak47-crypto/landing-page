...
export default function Navbar() {
    ...
    return (
        <div className="flex justify-between items-center px-4 py-4 md:px-20 md:py-5 mb-[28px]">
            ...
            {session?<Button onClick={() => signOut()} variant="destructive" className="hidden md:block" size={"sm"} >Sign out &rarr;</Button>:
            <Link href='/sign-up'>
                                <Button variant="destructive" className="hidden md:block" size={"sm"} >Get started &rarr;</Button></Link>}
            ...
            <Link href='/sign-up'>
                                <Button variant="destructive" className="" size={"sm"} >Get started &rarr;</Button></Link>}
